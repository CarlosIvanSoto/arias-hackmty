...
app = Blueprint('routes-handDetect', __name__)
...
def handD_feed():
    return Response(handDetect(), mimetype='multipart/x-mixed-replace; boundary=frame')

@app.route('/handD')
def handD():
    return render_template('testHand.html')
